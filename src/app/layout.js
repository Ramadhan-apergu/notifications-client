  ...
  return (
    <html lang="en">
      <body className="antialiased">
        ...
        <div className="lg:hidden fixed inset-0 bg-gray-800 bg-opacity-75 flex items-center justify-center text-center p-4">
          <div className="bg-white p-6 rounded-lg shadow-lg">
            <h2 className="text-lg font-semibold text-red-600 mb-4">Desktop Only</h2>
